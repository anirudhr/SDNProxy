...
# Copyright (c) 2014, Anirudh Ramachandran and Chintan Choksi.  All rights reserved.

# BEGIN Copyright for classes taken from twisted-connect-proxy https://github.com/fmoo/twisted-connect-proxy
# Classes taken from twisted-connect-proxy: ConnectProxyRequest, ConnectProxy, ConnectProxyClient, ConnectProxyClientFactory 
# Copyright (c) 2014, Peter Ruibal.  All rights reserved.
#
# This source code is licensed under the BSD-style license found in the
# LICENSE_for_twisted-connect-proxy file in the root directory of this source tree.
# END Copyright for classes taken from twisted-connect-proxy
